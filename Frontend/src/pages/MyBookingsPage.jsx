  ...
  return (
    <div className="min-h-screen bg-cinema-black py-20 px-4">
      <div className="max-w-5xl mx-auto">
        <h1 className="text-4xl font-display text-brand-primary mb-12 uppercase tracking-[0.2em] mt-12">
          My Tickets
        </h1>
        ...
        {isLoading ? (
          ...
          <div className="text-center py-20 glass-card">
            <h2 className="text-2xl font-display text-white/20 mb-2">
          ...
          <div className="text-center py-20 glass-card border-dashed border-2 border-white border-opacity-5">
            <div className="w-16 h-16 bg-white/5 rounded-full flex items-center justify-center mx-auto mb-6 text-cinema-muted">
              <svg
                className="w-8 h-8"
                fill="none"
                viewBox="0 0 24 24"
